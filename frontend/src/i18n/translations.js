...
export const translations = {
  de: {
    ...
    inbox: {
      title: 'Posteingang',
      subtitle: 'Kommentare und Nachrichten – unbeantwortete zuerst.',
      ...
      dm: {
        ...
        waitingLabel: 'Wartet auf Antwort',
        waitingOne: '1 Gespräch',
        waitingCount: '{n} Gespräche',
        allDone: 'Alles beantwortet',
        waiting: 'Unbeantwortet',
        answered: 'Beantwortet',
        reply: 'Senden',
        replyPlaceholder: 'Nachricht an @{username} …',
        sent: 'Nachricht gesendet.',
        hoursLeft: 'Noch etwa {n} Stunden Zeit zum Antworten.',
        windowClosed:
        ...
        checkedLine: '@{username}: {n} Gespräche',
        scopeNote:
          'Zeigt die letzten 15 Gespräche · pro Gespräch die letzten 12 Nachrichten · Antworten sind 24 Stunden lang möglich.',
      },
      reportedRead: 'Instagram {reported}, gelesen {read}',
  ...
  en: {
    ...
    inbox: {
      title: 'Inbox',
      subtitle: 'Comments and messages — unanswered first.',
      ...
      dm: {
        ...
        waitingLabel: 'Waiting for a reply',
        waitingOne: '1 conversation',
        waitingCount: '{n} conversations',
        allDone: 'All answered',
        waiting: 'Unanswered',
        answered: 'Answered',
        reply: 'Send',
        replyPlaceholder: 'Message @{username} …',
        sent: 'Message sent.',
        hoursLeft: 'About {n} hours left to reply.',
        windowClosed:
        ...
        checkedLine: '@{username}: {n} conversations',
        scopeNote:
          'Shows the last 15 conversations · the last 12 messages in each · replies are possible for 24 hours.',
      },
      reportedRead: 'Instagram {reported}, read {read}',
