...
export const translations = {
  tr: {
    ...
    appTagline: 'Yapay zeka destekli içerik merkezi',
    ...
    platforms: {
      title: 'Kanallarını seç',
      subtitle: 'İçeriğini yayınlamak istediğin sosyal medya hesaplarını bağla.',
      selected: 'kanal seçili',
      noneSelected: 'Henüz kanal seçmedin',
      connected: 'Bağlı',
      notConnected: 'Bağlı değil',
      selectAll: 'Tümünü seç',
      clearAll: 'Seçimi temizle',
      tipTitle: 'Tek içerik, her yerde',
      tipBody: 'Birden fazla kanal seçtiğinde, ürettiğin içerik her platformun kendi formatına otomatik uyarlanır.',
    },

    create: {
      title: 'İçerik üret',
      subtitle: 'Konuyu yaz, gerisini yapay zekâ halletsin.',
      formatLabel: 'İçerik biçimi',
      toneLabel: 'Üslup',
      topicLabel: 'Konu veya anahtar kelime',
      topicPlaceholder: 'Örn: yeni ürün lansmanı, haftalık ipucu, müşteri hikâyesi...',
      targetLabel: 'Yayınlanacak kanallar',
      generate: 'İçerik üret',
      generating: 'Üretiliyor...',
      resultLabel: 'Üretilen içerik',
      emptyResult: 'Henüz içerik üretilmedi. Bir konu yazıp "İçerik üret" butonuna bas.',
      copy: 'Kopyala',
      copied: 'Kopyalandı',
      regenerate: 'Yeniden üret',
      save: 'Taslağa kaydet',
      needTopic: 'Lütfen önce bir konu yaz.',
      needPlatform: 'Lütfen en az bir kanal seç.',
      ...
      media: {
        ...
        hint: 'Otomatik JPEG’e çevrilir · en fazla 8 MB',
        change: 'Değiştir',
        remove: 'Kaldır',
        uploading: 'Yükleniyor…',
        ready: 'Yüklendi',
        publish: 'Instagram’da yayınla',
        publishing: 'Yayınlanıyor…',
        processing: 'Instagram görseli işliyor…',
        published: 'Yayınlandı! 🎉',
        needImage: 'Önce bir görsel seç.',
        notAnImage: 'Bu bir görsel dosyası değil.',
        tooTall: 'Görsel çok uzun — Instagram en fazla 4:5 oranı kabul ediyor.',
        tooWide: 'Görsel çok geniş — Instagram en fazla 1.91:1 oranı kabul ediyor.',
        uploadFailed: 'Görsel yüklenemedi.',
        publishFailed: 'Yayınlanamadı.',
      },
      formats: {
        caption: 'Gönderi metni',
        hashtags: 'Etiket seti',
        hook: 'Dikkat çekici giriş',
      ...
      ideasTitle: 'Hazır fikirler',
      ideas: {
        launch: 'Ürün lansmanı',
        tip: 'Haftanın ipucu',
        story: 'Müşteri hikâyesi',
        behind: 'Kamera arkası',
      },
    },

    schedule: {
      title: 'Yayın takvimi',
      subtitle: 'Ne zaman, hangi sıklıkta paylaşılacağını belirle.',
      startLabel: 'Başlangıç saati',
      intervalLabel: 'Paylaşım aralığı',
      countLabel: 'Gönderi sayısı',
      everyHours: 'saatte bir',
      add: 'Takvime ekle',
      activeTitle: 'Aktif planlar',
      empty: 'Henüz plan eklemedin.',
      emptyHint: 'Yukarıdan saat ve aralık seçerek ilk planını oluştur.',
      delete: 'Sil',
      added: 'Plan takvime eklendi.',
      removed: 'Plan silindi.',
      posts: 'gönderi',
      preview: 'Yayın saatleri',
      needPlatform: 'Önce Kanallar sekmesinden en az bir kanal seç.',
    },

    analytics: {
      title: 'Performans raporu',
      subtitle: 'Tüm kanallarının verilerini tek ekranda gör.',
      range7: '7 gün',
      range30: '30 gün',
      range90: '90 gün',
      totals: 'Toplam veriler',
      byPlatform: 'Kanal bazında',
      views: 'Görüntülenme',
      likes: 'Beğeni',
      comments: 'Yorum',
      followers: 'Takipçi',
      engagement: 'Etkileşim',
      topContent: 'En iyi performans',
      empty: 'Rapor için önce kanal seçmelisin.',
      emptyAction: 'Kanallara git',
      vsPrevious: 'önceki döneme göre',
    },

    settings: {
      title: 'Ayarlar',
      subtitle: 'Dil tercihini ve kanal bağlantılarını yönet.',
      languageTitle: 'Uygulama dili',
      languageHint: 'Tüm arayüz ve üretilen içerikler seçtiğin dilde olur.',
      apiTitle: 'Kanal bağlantıları',
      apiHint: 'Her kanal için erişim bilgilerini gir.',
      noPlatforms: 'Önce Kanallar sekmesinden kanal seç.',
      goToPlatforms: 'Kanallara git',
      ...
      securityBody: 'Anahtarların yalnızca bu cihazın tarayıcısında saklanır. Kimseyle paylaşma.',
